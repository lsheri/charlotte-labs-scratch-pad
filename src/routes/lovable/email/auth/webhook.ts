...
// Configuration
const SITE_NAME = "charlotte-study-hub"
const SENDER_DOMAIN = "notify.charlotte-labs.com"
const ROOT_DOMAIN = "charlotte-labs.com"
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Fire-and-forget: kick the queue processor so the email leaves
        // within ~1s instead of waiting for the hourly safety-net cron.
        kickEmailQueue()
